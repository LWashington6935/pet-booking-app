...
export const metadata: Metadata = {
  ...
  description: 'Book trusted pet walkers and sitters in your area. Professional pet care services with real-time booking, GPS tracking, and 24/7 support.',
  ...
  openGraph: {
    ...
    description: 'Book trusted pet walkers and sitters in your area with real-time tracking and 24/7 support.',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
        height: 630,
        alt: 'Pet Booking - Professional Pet Care Services',
      },
    ],
  },
  twitter: {
    ...
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="min-h-screen bg-gradient-to-br from-white to-slate-50 text-gray-900 dark:from-slate-950 dark:to-slate-900 dark:text-slate-100 antialiased">
        <div className="flex min-h-screen flex-col">
          ...
          <footer 
            className="border-t border-gray-200 dark:border-slate-800 bg-white/50 dark:bg-slate-950/50 backdrop-blur-sm"
            role="contentinfo"
          >
